...
def formFill():
    ...
    for i in range(int(countOfPersons)):
        ...
        # pyautogui.typewrite(person['name'].strip())
        human_typing(person['name'].strip())
        # autoit.send(person['name'].strip())
        autoit.send("{TAB}")
        speed_for_first_page(speed)
        # autoit_slow_type_numbers_with_error(person['mobile'].strip())
        # autoit.send(person['mobile'].strip())
        # pyautogui.typewrite(person['mobile'].strip())
        human_typing(person['mobile'].strip())
        speed_for_first_page(speed)
        autoit.send("{TAB}")
        speed_for_first_page(speed)
        ...
        # autoit.send(person['idNumber'].strip())
        # pyautogui.typewrite(person['idNumber'].strip())
